...
const ConfirmRideCaptainPopup = ({setRidePopupPanel, setConfirmRidePopupPanel}) => {
  return (
    <div>
      <h5
        onClick={() => {
      ...
      <div className="flex gap-2 flex-col justify-between items-center">
        ...
        <Link to="/captain-riding" className="flex justify-center w-full mt-5 bg-green-600 text-white font-semibold p-3 rounded-lg">
          Confirm
        </Link>
        <button onClick={()=>{
            setConfirmRidePopupPanel(false);
